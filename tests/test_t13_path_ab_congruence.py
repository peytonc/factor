...
After an A<->B fork at a random parent, an identical random suffix on both
branches stays congruent mod 2*b_parent at every descendant depth.
"""
...
def test_t13(cfg):
    chk = Checker("T13", "Path A/B Modular Congruence")
    _fork_congruence(chk, cfg, ("A", "B"), "t13")
